...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-base-200 p-6 flex flex-col items-center pt-20 md:justify-center md:pt-0 transition-all duration-300">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 w-full max-w-sm md:max-w-4xl transition-all">
        <div
          onClick={() => navigate('/order')}
          className="card bg-base-100 shadow-xl col-span-2 md:col-span-1 hover:shadow-2xl hover:bg-base-100/60 hover:-translate-y-1 active:scale-95 transition-all duration-300 cursor-pointer group"
        >
        ...
        >
          <div className="card-body flex flex-col items-center justify-center gap-3 py-6 md:py-12">
